---
title: "`r paste('PaRe Report:', params$pkgName)`"
...
DT::datatable(PaRe::checkDependencies(repo = repo, nThreads = nThreads))
```
...
graphData <- PaRe::getGraphData(repo = repo, nThreads = nThreads)
